        ...
        <div className="flex flex-col sm:flex-row justify-between gap-10">
          ...
          >
            ...
            <div>
              ...
              <a
                href="https://drive.google.com/file/d/1mqUQkMlo71EOz-V9kzpGZvSkM-65A-WN/view?usp=sharing"
        ...
        <div className="py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 lg:py-24">
          <div className="sm:border-[#33353F] sm:border rounded-md py-8 px-16 flex flex-col gap-10 sm:flex-row items-center justify-between">
            <div className="flex flex-col gap-2 text-center">
              ...
              <p className="text-gray-400 text-base">Projetos</p>
            </div>
            <div className="flex flex-col gap-2 text-center">
              <h1 className="font-bold flex justify-center text-4xl">
                <AnimatedNumbers
              ...
              <p className="text-gray-400 text-base">Clientes</p>
            </div>
            <div className="flex flex-col gap-2 text-center">
              <h1 className="font-bold flex justify-center text-4xl">
                <AnimatedNumbers
              ...
              <p className="text-gray-400 text-base">Apresentações</p>
            </div>
            <div className="flex flex-col gap-2 text-center">
              <h1 className="font-bold flex justify-center text-4xl">
                <AnimatedNumbers
              ...
              <p className="text-gray-400 text-base">Anos</p>
            </div>
          </div>
        </div>
      </MaxWidthWrapper>
